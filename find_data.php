...
<!-- 정보 -->
<?php include "./include/f_avg.php"; ?>
<div class="view2">
  <div class="temp"><i class="fas fa-thermometer-full"></i> <?=round($avgT/$count, 1)?><span class="small">ºC</span></div>
  <div class="hum"><i class="fas fa-tint"></i> <?=round($avgH/$count, 1)?><span class="small">%</span></div>
</div>
<div class="time"><?=$dateVal?>의 평균</div>
<!-- 메인으로 -->
   <h3><a href="index.php" class="section">돌아가기</a></h3>

<?php include "./include/f_graph_avg.php"; ?>
<!-- 검색일의 그래프 표시 -->
...
<!-- 검색일의 정보 표시 접기/펼치기 기능버튼 -->
    <span id="more" style="CURSOR: pointer" onclick="if(story.style.display=='none') {story.style.display='';more.innerText='>접기'} else {story.style.display='none';more.innerText='>모든 온도 값 보기'}">>모든 온도 값 보기</span>
      ...
      <?php include "./include/f_make_table.php"; ?>
    <HR></div>
  <br>
  <br>
